  ...
  async createWindow(): Promise<BrowserWindow> {
    const browserWindow = new BrowserWindow({
      ...
      webPreferences: {
        ...
        webviewTag: false, // The webview tag is not recommended. Consider alternatives like an iframe or Electron's WebContentsView. @see https://www.electronjs.org/docs/latest/api/webview-tag#warning
